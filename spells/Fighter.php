...
<section class="content-wrap">
   ...
   <div class="youplay-banner banner-top youplay-banner-parallax small" data-jarallax-original-styles="null" style="background-image: none; background-attachment: scroll; background-size: auto;">
      <div class="image" style="background-image: url(&quot;<?php echo Base_url();?>layout/images/heroes/Fighter_1.png&quot;); transform: translate3d(0px, 0px, 0px);">
      </div>
            ...
            <div class="news-one">
               <div class="row vertical-gutter">
                  <div class="col-md-4">
                     <a class="angled-img">
                        <div class="img">
                           <img src="<?php echo Base_url(); ?>layout/images/spells/Fighter/<?php echo $spell['spell_img']; ?>" alt="Hero" height="150" width="150"/>
                        </div>
                     </a>
                  </div>
                  <div class="col-md-8">
